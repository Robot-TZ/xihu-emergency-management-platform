...
import type { EmergencyPlan, EventRecord, OperationalRecord, ProductModule, TaskRecord } from "@/lib/types";
...
export function ReviewCenterPage({ events, tasks, records, activeEventId, writable, onSelectEvent, onAdd, onUpdate, onDelete }: RecordActions & {
  events: EventRecord[];
  tasks: TaskRecord[];
